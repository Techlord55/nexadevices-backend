...
if DEBUG and '*' in config('CORS_ALLOWED_ORIGINS', default=''):
...
GOOGLE_DEVELOPER_KEY = config('GOOGLE_DEVELOPER_KEY', default='')
...
ADMINS = [
    ('Admin', config('ADMIN_EMAIL', default='admin@nexadevices.com')),
]
MANAGERS = ADMINS
...
# Admin URL customization (change this in production)
